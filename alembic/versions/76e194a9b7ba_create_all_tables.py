...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("scopes", postgresql.JSONB(), server_default="[]", nullable=True),
        ...
        sa.ForeignKeyConstraint(
            ["site_id"], ["sites.id"], name=op.f("fk_actors_site_id_sites"), ondelete="SET NULL"
        ),
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("now()"), nullable=False),
        sa.ForeignKeyConstraint(
            ["site_id"], ["sites.id"], name=op.f("fk_redirects_site_id_sites"), ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.Column("events", postgresql.JSONB(), server_default="[]", nullable=True),
        sa.Column("active", sa.Boolean(), server_default="true", nullable=False),
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("now()"), nullable=False),
        sa.ForeignKeyConstraint(
            ["site_id"], ["sites.id"], name=op.f("fk_webhooks_site_id_sites"), ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["created_by_actor_id"],
            ["actors.id"],
            name=op.f("fk_assets_created_by_actor_id_actors"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["site_id"], ["sites.id"], name=op.f("fk_assets_site_id_sites"), ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.Column("verbs", postgresql.JSONB(), server_default='["GET"]', nullable=True),
        sa.Column("expires_at", sa.DateTime(), nullable=True),
        sa.Column("uses_remaining", sa.Integer(), nullable=True),
        sa.Column("revoked_at", sa.DateTime(), nullable=True),
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("now()"), nullable=False),
        sa.ForeignKeyConstraint(
            ["actor_id"], ["actors.id"], name=op.f("fk_capability_links_actor_id_actors"), ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.Column("frontmatter", postgresql.JSONB(), server_default="{}", nullable=True),
        ...
        sa.ForeignKeyConstraint(
            ["created_by_actor_id"],
            ["actors.id"],
            name=op.f("fk_posts_created_by_actor_id_actors"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["site_id"], ["sites.id"], name=op.f("fk_posts_site_id_sites"), ondelete="CASCADE"
        ),
    ...
    op.create_index(
        ...
        "posts",
        ["site_id", "status", sa.literal_column("published_at DESC"), "id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["actor_id"], ["actors.id"], name=op.f("fk_post_revisions_actor_id_actors"), ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["post_id"], ["posts.id"], name=op.f("fk_post_revisions_post_id_posts"), ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        # No UNIQUE(post_id, tag_id): the composite primary key above already
        # enforces it and PostgreSQL does not create a duplicate constraint.
    )
