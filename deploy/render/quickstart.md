# Deploy to Render (Free Tier) — **UNVERIFIED**

> ⚠️ **This guide is UNVERIFIED and NOT RECOMMENDED for production use.**
>
> The platform manifest (`render.yaml`) referenced in this guide
> **does not exist** in the repository. The guide also does not set `AGENTCMS_IMAGE_TAG`
